...
class Types {
	...
	private static function _checkDefaultType($type) {
	...
	private static function _getTypesByClass($path_types_class) {
	...
	public static function isValidModelName($model_name) {
	...
	public static function getAvailableTypes() {
		// default types
		$available_types['default'] = self::_getTypesByClass(Parser::getPath('custom_standards_rf'));
		// driver types
		$available_types['driver'] = self::_getTypesByClass(Parser::getPath('driver_standards_rf').
															 Settings::getParam('driver'));
